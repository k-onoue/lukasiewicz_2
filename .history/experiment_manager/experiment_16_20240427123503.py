...
settings_list = [
    {
        'path': os.path.join(project_dir_path, "experiment_result/tmp/version_161"),
        # 'source_paths': [file_path_1, file_path_2, file_path_3],
        'source_paths': [file_path_1, file_path_2],
        'experiment_name': 'pima_indian_diabetes_cv_16',
        'seed': 42,
        'n_splits': 5,
        'n_unsupervised': 15,
        'c1': 10,
    ...
    {
        'path': os.path.join(project_dir_path, "experiment_result/tmp/version_162"),
        # 'source_paths': [file_path_1, file_path_2, file_path_3],
        'source_paths': [file_path_1, file_path_2],
        'experiment_name': 'pima_indian_diabetes_cv_16',
        'seed': 42,
    ...
    {
        'path': os.path.join(project_dir_path, "experiment_result/tmp/version_163"),
        # 'source_paths': [file_path_1, file_path_2, file_path_3],
        'source_paths': [file_path_1, file_path_2],
        'experiment_name': 'pima_indian_diabetes_cv_16',
        'seed': 42,
    ...
    {
        'path': os.path.join(project_dir_path, "experiment_result/tmp/version_164"),
        # 'source_paths': [file_path_1, file_path_2, file_path_3],
        'source_paths': [file_path_1, file_path_2],
        'experiment_name': 'pima_indian_diabetes_cv_16',
        'seed': 42,
    ...
    {
        'path': os.path.join(project_dir_path, "experiment_result/tmp/version_165"),
        # 'source_paths': [file_path_1, file_path_2, file_path_3],
        'source_paths': [file_path_1, file_path_2],
        'experiment_name': 'pima_indian_diabetes_cv_16',
        'seed': 42,
    ...
    {
        'path': os.path.join(project_dir_path, "experiment_result/tmp/version_166"),
        # 'source_paths': [file_path_1, file_path_2, file_path_3],
        'source_paths': [file_path_1, file_path_2],
        'experiment_name': 'pima_indian_diabetes_cv_16',
        'seed': 42,
    ...
    {
        'path': os.path.join(project_dir_path, "experiment_result/tmp/version_167"),
        # 'source_paths': [file_path_1, file_path_2, file_path_3],
        'source_paths': [file_path_1, file_path_2],
    ...
    {
        'path': os.path.join(project_dir_path, "experiment_result/tmp/version_168"),
        # 'source_paths': [file_path_1, file_path_2, file_path_3],
        'source_paths': [file_path_1, file_path_2],
        'experiment_name': 'pima_indian_diabetes_cv_15',
        'seed': 42,
...
for settings in settings_list:
    ...
    for i, (train_idx, test_idx) in enumerate(kf.split(df_origin_1)):
        ...
        # Association Rule
        # Association Rule
        rules_df = get_rules(df_origin_2.copy().iloc[train_idx], min_threshold=settings['rule_thr'], conclusion_name='Outcome')
        rules_df.to_csv(os.path.join(settings['path'], f'rules/rules_{i}_original.csv'))
        ...
        KB_origin = rule_processor.construct_KB()
        rules_df['antecedents'] = rules_df['antecedents'].apply(lambda x: str(x).strip('frozenset({})'))
        rules_df['consequents'] = rules_df['consequents'].apply(lambda x: str(x).strip('frozenset({})'))
        rules_df.to_csv(os.path.join(settings['path'], f'rules/rules_{i}.csv'))
        rule_processor.save_KB_as_txt(os.path.join(settings['path'], f'rules/rules_{i}.txt'))
