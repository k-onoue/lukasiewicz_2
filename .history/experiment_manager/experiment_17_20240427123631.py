...
settings_list = [
    {
        'path': os.path.join(project_dir_path, "experiment_result/tmp/version_171"),
        # 'source_paths': [file_path_1, file_path_2, file_path_3],
        'source_paths': [file_path_1, file_path_2],
        'experiment_name': 'pima_indian_diabetes_cv_17',
        'seed': 42,
        'n_splits': 5,
        'n_unsupervised': 15,
        'c1': 10,
    ...
    {
        'path': os.path.join(project_dir_path, "experiment_result/tmp/version_172"),
        # 'source_paths': [file_path_1, file_path_2, file_path_3],
        'source_paths': [file_path_1, file_path_2],
        'experiment_name': 'pima_indian_diabetes_cv_17',
        'seed': 42,
    ...
    {
        'path': os.path.join(project_dir_path, "experiment_result/tmp/version_173"),
        # 'source_paths': [file_path_1, file_path_2, file_path_3],
        'source_paths': [file_path_1, file_path_2],
        'experiment_name': 'pima_indian_diabetes_cv_17',
        'seed': 42,
    ...
    {
        'path': os.path.join(project_dir_path, "experiment_result/tmp/version_174"),
        # 'source_paths': [file_path_1, file_path_2, file_path_3],
        'source_paths': [file_path_1, file_path_2],
