...
settings_list = [
    {
        'path': os.path.join(project_dir_path, "experiment_result/tmp/version_181"),
        # 'source_paths': [file_path_1, file_path_2, file_path_3],
        'source_paths': [file_path_1, file_path_2],
        'experiment_name': 'pima_indian_diabetes_cv_18',
        'seed': 42,
        'n_splits': 5,
        'n_unsupervised': 15,
        'c1': 10,
    ...
    {
        'path': os.path.join(project_dir_path, "experiment_result/tmp/version_182"),
        # 'source_paths': [file_path_1, file_path_2, file_path_3],
        'source_paths': [file_path_1, file_path_2],
        'experiment_name': 'pima_indian_diabetes_cv_18',
        'seed': 42,
    ...
    {
        'path': os.path.join(project_dir_path, "experiment_result/tmp/version_183"),
        # 'source_paths': [file_path_1, file_path_2, file_path_3],
        'source_paths': [file_path_1, file_path_2],
        'experiment_name': 'pima_indian_diabetes_cv_18',
        'seed': 42,
    ...
    {
        'path': os.path.join(project_dir_path, "experiment_result/tmp/version_184"),
        # 'source_paths': [file_path_1, file_path_2, file_path_3],
        'source_paths': [file_path_1, file_path_2],
        'experiment_name': 'pima_indian_diabetes_cv_18',
        'seed': 42,
    ...
    {
        'path': os.path.join(project_dir_path, "experiment_result/tmp/version_185"),
        # 'source_paths': [file_path_1, file_path_2, file_path_3],
        'source_paths': [file_path_1, file_path_2],
        'experiment_name': 'pima_indian_diabetes_cv_18',
        'seed': 42,
