...
settings_list = [
    {
        'path': os.path.join(project_dir_path, "experiment_result/tmp/version_191"),
        # 'source_paths': [file_path_1, file_path_2, file_path_3],
        'source_paths': [file_path_1, file_path_2],
        'experiment_name': 'pima_indian_diabetes_cv_19',
        'seed': 42,
        'n_splits': 5,
        'n_unsupervised': 1,
        'c1': 10,
    ...
    {
        'path': os.path.join(project_dir_path, "experiment_result/tmp/version_192"),
        # 'source_paths': [file_path_1, file_path_2, file_path_3],
        'source_paths': [file_path_1, file_path_2],
        'experiment_name': 'pima_indian_diabetes_cv_19',
        'seed': 42,
