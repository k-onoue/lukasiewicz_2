...
settings_list = [
    {
        ...
        'experiment_name': 'pima_indian_diabetes_cv_5',
        'seed': 42,
        'n_splits': 5,
        'n_unsupervised': 15,
        'c1': 10,
